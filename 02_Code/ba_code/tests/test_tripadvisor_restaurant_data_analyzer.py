...
def print_infos_of_tripadvisor_restaurant_data_of_all_restaurants():
    ...
    tripadvisor_restaurant_data_extractors = restaurant_review_data_analyzer.get_restaurant_review_data_extractors_dict()
...
def test_google_review_data_format():
    path = TRIPADVISOR_RESTAURANT_GOOGLE_DATASET_PATH
    data_type = RestaurantReviewDataType.GOOGLE_REVIEW
    restaurant_review_data_analyzer = RestaurantReviewDataAnalyzer(path, data_type)
    restaurant_review_data_extractors = restaurant_review_data_analyzer.get_restaurant_review_data_extractors_dict()

    for restaurant_review_data_extractor in restaurant_review_data_extractors.values():
        if restaurant_review_data_extractor.get_number_of_reviews() != len(
                restaurant_review_data_extractor.get_review_data_dataframe()):
            print("Restaurant name:", restaurant_review_data_extractor.get_restaurant_name())

def test_tripadvisor_review_data_format():
    path = TRIPADVISOR_RESTAURANT_DATA_PATH
    data_type = RestaurantReviewDataType.TRIPADVISOR_REVIEW
    restaurant_review_data_analyzer = RestaurantReviewDataAnalyzer(path, data_type)
    restaurant_review_data_extractors = restaurant_review_data_analyzer.get_restaurant_review_data_extractors_dict()
...
def test_tripadvisor_rating_only_rating_format():
...
def print_author_level_infos():
    ...
    tripadvisor_restaurant_data = tripadvisor_restaurant_data_analyzer.get_restaurant_review_data_extractors_dict()
